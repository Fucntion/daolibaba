...
export const forget = (post) => fetch('/v1/member/forget',emptyObject(post),'POST');
...
export const smsLogin = (post) => fetch('/v1/member/smsLogin',emptyObject(post), 'POST');

export const search = (post) => fetch('/v1/search', emptyObject(post), 'POST');

export const selerMall = (post) => fetch('/sellerapi/mall', emptyObject(post), 'POST');

export const sellerOrder = (post) => fetch('/sellerapi/order', emptyObject(post), 'POST');


export const sellerAmount= (post) => fetch('/sellerapi/amount', emptyObject(post), 'POST');

export const sellerWithdraw = (post) => fetch('/sellerapi/withdraw', emptyObject(post), 'POST');
