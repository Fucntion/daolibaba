...
<template>
  <div>
      ...
      <div class="form">
        ...
        <div class="margin15"><mt-button @click="sub" class="sub" size="large">登录</mt-button></div>
        <div class="margin15-c"><router-link to="/smslogin"><mt-button  class="sub" size="large" type="primary">快捷登录</mt-button></router-link></div>
      </div>

    <div>
      <router-link   :to="'/forget'" class="head_login padding15 forget">
        <span class="login_span font14" >修改/忘记密码</span>
      </router-link>
    </div>
