...
<template>
  <div>
    ...
    <div class="my-order margin15-r" v-if="userInfo">
      ...
      <router-link to="/order?status=0" class="order"><i class="iconfont icon-fukuan"></i><span class="key">待付款({{userInfo.orderNeedPayCount}})</span></router-link>
      <router-link to="/order?status=2" class="order"><i class="iconfont icon-ziyuan"></i><span class="key">待收货({{userInfo.orderNeedCheckExpressCount}})</span></router-link>
      <router-link to="/order?status=4" class="order"><i class="iconfont icon-daipingjia20"></i><span class="key">待评价({{userInfo.orderNeedCheckScoreCount}})</span></router-link>
      <router-link to="/order?status=6" class="order"><i class="iconfont icon-icondd2"></i><span class="key">退款/售后({{userInfo.orderNeedRefundCount}})</span></router-link>
    </div>
